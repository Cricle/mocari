...
pub use expression3::{
    ...
    ExpressionBlend, ExpressionParameter, ExpressionTarget, apply_expression_blend,
    apply_expression_parameter, resolved_expression_fade_in_time, resolved_expression_fade_out_time,
};
...
pub use motion3::{
    ...
    VertexMotionCurve, apply_motion_fade, easing_sine, motion_fade_in_weight,
    motion_fade_out_weight, parameter_curve_fade_weight,
};
pub use physics3::{
